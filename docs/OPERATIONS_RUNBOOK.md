...
|---|---|---|
| `www.aurivian.nl` HTTP 525 | Low — apex works | Add Cloudflare Redirect Rule: `www → https://aurivian.nl` |
| Magic link email delivery | Medium | Token currently logged to console only; no email sent |
